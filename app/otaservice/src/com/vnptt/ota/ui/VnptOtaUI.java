...
import com.vnptt.ota.common.RecoveryUtil;
...
import com.vnptt.ota.download.DownloadUtils;
...
public class VnptOtaUI extends Activity implements OnClickListener, Handler.Callback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvDevice.setText(android.os.Build.MODEL);
	...
	public boolean handleMessage(Message msg) {
		...
		case MSG_TYPE.DOWNLOAD_INPROGESS:
			...
			if(notifyMgr != null)
				notifyMgr.showDownloadingNotificaton(progress, true);
			break;
		case MSG_TYPE.DOWNLOAD_ERROR:
