...
import com.vnptt.ota.common.NotifyManager;
import com.vnptt.ota.common.VnptOtaState;
import com.vnptt.ota.common.VnptOtaUtils;
import com.vnptt.ota.download.DownloadManager;
...
import com.vnptt.ota.ui.AlertNewFirmwareAvailable;
import com.vnptt.ota.ui.AlertDownloadFirmwareDone;
import com.vnptt.ota.ui.AlertUpgradeFirmware;
	...
	private class OtaIntentReceiver extends BroadcastReceiver {
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equalsIgnoreCase("android.net.conn.CONNECTIVITY_CHANGE")) {
				...
				if ((otaState.getState() == VnptOtaState.STATE_QUERY_FIRMWARE) || (otaState.getState() == VnptOtaState.STATE_QUERY)) {
