...
import com.vnptt.ota.test.VnptOtaHelperMgr;
import com.vnptt.ota.test.VnptOtaHelperMgr.VnptOtaHelperMgrCallback;
import com.vnptt.ota.test.VnptOtaHelperMgrUtils;
...
public class UpdateFwUIActivity extends Activity implements OnClickListener, Handler.Callback {
	...
	private VnptOtaHelperMgrCallback otaCallback = new VnptOtaHelperMgrCallback() {	
		@Override
